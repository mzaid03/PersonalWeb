...
function App() {
 ...
 <p className="tech-stack">Python, NumPy, Pandas, Scikit-learn, Matplotlib, Seaborn, Machine Learning</p>
 <ul>
 ...
 <h3>PrioritiTask</h3>
 <p className="tech-stack">React, Next.js, Node.js, TypeScript, Tailwind CSS, HTML, CSS, JSON, Prisma, PostgreSQL, REST APIs, npm, Docker, Git/GitHub, ESLint, PostCSS, Railway</p>
 <ul>
